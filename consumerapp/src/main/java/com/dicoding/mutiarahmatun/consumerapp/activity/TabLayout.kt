...
import com.dicoding.mutiarahmatun.consumerapp.adapter.AdapterSection
import com.dicoding.mutiarahmatun.consumerapp.databinding.ActivityTabLayoutBinding
...
class TabLayout : AppCompatActivity() {
    ...
    companion object {
        @StringRes
        internal val TAB_TITLE = intArrayOf(
